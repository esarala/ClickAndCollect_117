'###################################################################################################################
'Test Script Name: "TC_06_CnC_To Verify Extend Order button is disabled for already collected order
...
TestScriptName = "TC_06_CnC_To Verify Extend Order button is disabled for already collected orders"
...
wait 2
' as a pre requisite, already collected order should be given as input
