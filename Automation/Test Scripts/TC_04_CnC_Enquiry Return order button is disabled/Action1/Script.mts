'###################################################################################################################
'Test Script Name: TC_04_CnC_Enquiry Return order button is disabled
...
TestScriptName = "TC_04_CnC_Enquiry Return order button is disabled"
...
'backoffice login
wait 2
JavaWindow("Oracle Retail Xstore Point").JavaList("DtvList").Select "#3" @@ hightlight id_;_1349033543_;_script infofile_;_ZIP::ssf1.xml_;_
wait 2
JavaWindow("Oracle Retail Xstore Point").JavaList("DtvList").Select "#2" @@ hightlight id_;_1349033543_;_script infofile_;_ZIP::ssf2.xml_;_
wait 2
JavaWindow("Oracle Retail Xstore Point").JavaList("Search Criteria").Select "All Orders"
wait 2
'JavaWindow("Oracle Retail Xstore Point").JavaEdit("Input Search Criteria").Set strParcelReference @@ hightlight id_;_246910447_;_script infofile_;_ZIP::ssf5.xml_;_
wait 2
JavaWindow("Oracle Retail Xstore Point").JavaButton("Confirm").Click
wait 2
'JavaWindow("Oracle Retail Xstore Point").JavaButton("OK").Click
wait 2
JavaWindow("Oracle Retail Xstore Point").JavaList("DtvList").Select "#0" @@ hightlight id_;_4503928_;_script infofile_;_ZIP::ssf8.xml_;_
wait 2
JavaWindow("Oracle Retail Xstore Point").JavaButton("Confirm").Click
' pr = ZW924750388GB
...
'End If
If JavaWindow("Oracle Retail Xstore Point").JavaButton("Return Order").Exist(2) Then
	Reporter.ReportEvent micPass,"Verify Return Order Button is disabled","Confirm Button is disabled"
Else
	Reporter.ReportEvent micFail,"Verify Return Order Button is disabled","Confirm Button is enabled"
End If
wait 2
JavaWindow("Oracle Retail Xstore Point").JavaButton("Back").Click @@ hightlight id_;_110117321_;_script infofile_;_ZIP::ssf9.xml_;_
wait 2
JavaWindow("Oracle Retail Xstore Point").JavaButton("Back").Click @@ hightlight id_;_110117321_;_script infofile_;_ZIP::ssf10.xml_;_
wait 2
JavaWindow("Oracle Retail Xstore Point").JavaButton("Back_2").Click @@ hightlight id_;_1200813389_;_script infofile_;_ZIP::ssf11.xml_;_
wait 2
